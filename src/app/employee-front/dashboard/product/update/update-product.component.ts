...
import { CustomUpdateVariant } from '@/app/employee-front/dashboard/product/product-variant';
...
export class UpdateProductComponent implements OnInit {
  ...
  openCreateVariantComponent(): Observable<number> {
    ...
    return this.afterComponentClose(of()).pipe(map(() => 0));
  }
